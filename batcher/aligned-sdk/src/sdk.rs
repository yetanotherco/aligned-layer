use crate::{
    ...
    core::{
        constants::{
            ADDITIONAL_SUBMISSION_GAS_COST_PER_PROOF, DEFAULT_CONSTANT_GAS_COST, INSTANT_MAX_FEE_BATCH_SIZE, DEFAULT_MAX_FEE_BATCH_SIZE, GAS_PRICE_PERCENTAGE_MULTIPLIER, PERCENTAGE_DIVIDER
        },
