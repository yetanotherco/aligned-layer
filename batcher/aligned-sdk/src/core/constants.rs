/// Batcher ///
pub const TRANSACTION_WAIT_TIMEOUT: u64 = 36_000; // 3 blocks
...
pub const OVERRIDE_GAS_PRICE_PORCENTAGE_MULTIPLIER: u128 = 120; // gasPrice modifier to override previous transactions
