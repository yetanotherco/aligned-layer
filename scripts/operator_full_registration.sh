...
## Generated and add keys to config
...
OPERATOR_ADDRESS=$OPERATOR_ADDRESS $BASE_DIR/fund_operator_devnet.sh
...
# Mint mock tokens
$BASE_DIR/mint_mock_token.sh $CONFIG_FILE 100000000000000000
