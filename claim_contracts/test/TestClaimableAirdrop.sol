...
/// @title Test Claimable Airdrop
/// @notice This contract is the implementation of the Claimable Airdrop for testing
contract TestClaimableAirdrop is
    Initializable,
    ...
    Ownable2StepUpgradeable
{
    ...
    function claim(
        ...
        require(!hasClaimed[claimer], "Account has already claimed the drop");
        require(
