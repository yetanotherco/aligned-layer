...
| private_key_store_path        | Path to the ECDSA keystore in the Operator host                                                                                                                                    | `/home/{{ ansible_user }}/.keystores/operator.ecdsa`                                                                          | `/home/{{ ansible_user }}/.keystores/operator.ecdsa`                                                                          | `/home/{{ ansible_user }}/.keystores/operator.ecdsa` |
...
| Variable                                  | Description                                                                                                                                                                        | Stage                                                                                                                            | Testnet                                                                                                                    | Mainnet                                                       |
|-------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|
| aligned_layer_deployment_config_file_path | JSON with Aligned contracts addresses                                                                                                                                              | `/home/{{ ansible_user }}/repos/batcher/aligned_layer/contracts/script/output/holesky/alignedlayer_deployment_output.stage.json` | `/home/{{ ansible_user }}/repos/batcher/aligned_layer/contracts/script/output/holesky/alignedlayer_deployment_output.json` | TBD                                                           |
| eigen_layer_deployment_config_file_path   | JSON with EigenLayer contracts addresses                                                                                                                                           | `/home/{{ ansible_user }}/repos/batcher/aligned_layer/contracts/script/output/holesky/eigenlayer_deployment_output.json`         | `/home/{{ ansible_user }}/repos/batcher/aligned_layer/contracts/script/output/holesky/eigenlayer_deployment_output.json`   | TBD                                                           |
...
| ecdsa_private_key_store_path              | Path to the ECDSA keystore in the Operator host                                                                                                                                    | `/home/{{ ansible_user }}/.keystores/operator.ecdsa`                                                                             | `/home/{{ ansible_user }}/.keystores/operator.ecdsa`                                                                       | `/home/{{ ansible_user }}/.keystores/operator.ecdsa`          |
...
| bls_private_key_store_path                | Path to the BLS keystore in the Operator host                                                                                                                                      | `/home/{{ ansible_user }}/.keystores/operator.bls`                                                                               | `/home/{{ ansible_user }}/.keystores/operator.bls`                                                                         | `/home/{{ ansible_user }}/.keystores/operator.bls`            |
...
| last_processed_batch_filepath             | Where to store the last processed batch for system recovery                                                                                                                        | `/home/{{ ansible_user }}/operator.last_processed_batch.json`                                                                    | `/home/{{ ansible_user }}/operator.last_processed_batch.json`                                                              | `/home/{{ ansible_user }}/operator.last_processed_batch.json` |
...
| Variable                                  | Description                                                                                                                                                                        | Stage                                                                                                                               | Testnet                                                                                                                       | Mainnet                                                       |
|-------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|
| aligned_layer_deployment_config_file_path | JSON with Aligned contracts addresses                                                                                                                                              | `/home/{{ ansible_user }}/repos/aggregator/aligned_layer/contracts/script/output/holesky/alignedlayer_deployment_output.stage.json` | `/home/{{ ansible_user }}/repos/aggregator/aligned_layer/contracts/script/output/holesky/alignedlayer_deployment_output.json` | TBD                                                           |
| eigen_layer_deployment_config_file_path   | JSON with EigenLayer contracts addresses                                                                                                                                           | `/home/{{ ansible_user }}/repos/aggregator/aligned_layer/contracts/script/output/holesky/eigenlayer_deployment_output.json`         | `/home/{{ ansible_user }}/repos/aggregator/aligned_layer/contracts/script/output/holesky/eigenlayer_deployment_output.json`   | TBD                                                           |
| eth_rpc_url                               | HTTP RPC url                                                                                                                                                                       | <your_rpc_http_provider>                                                                                                            | <your_rpc_http_provider>                                                                                                      | <your_rpc_http_provider>                                      |
| eth_rpc_url_fallback                      | HTTP RPC fallback url. Must be different than `eth_rpc_url`                                                                                                                        | `https://ethereum-holesky-rpc.publicnode.com`                                                                                       | `https://ethereum-holesky-rpc.publicnode.com`                                                                                 | `https://ethereum-rpc.publicnode.com`                         |
| eth_ws_url                                | WS RPC url                                                                                                                                                                         | <your_rpc_ws_provider>                                                                                                              | your_rpc_ws_provider>                                                                                                         | <your_rpc_ws_provider>                                        |
| eth_ws_url_fallback                       | WS RPC fallback url. Must be different than `eth_ws_rpc_url`                                                                                                                       | `wss://ethereum-holesky-rpc.publicnode.com`                                                                                         | `wss://ethereum-holesky-rpc.publicnode.com`                                                                                   | `wss://ethereum-rpc.publicnode.com`                           |
| ecdsa_private_key_store_path              | Path to the ECDSA keystore in the Operator host                                                                                                                                    | `/home/{{ ansible_user }}/.keystores/aggregator.ecdsa`                                                                              | `/home/{{ ansible_user }}/.keystores/aggregator.ecdsa`                                                                        | `/home/{{ ansible_user }}/.keystores/operator.ecdsa`          |
| ecdsa_private_key_store_password          | Password of the ECDSA keystore                                                                                                                                                     | <your_ecdsa_keystore_password>                                                                                                      | <your_ecdsa_keystore_password>                                                                                                | <your_ecdsa_keystore_password>                                |
| bls_private_key_store_path                | Path to the BLS keystore in the Operator host                                                                                                                                      | `/home/{{ ansible_user }}/.keystores/aggregator.bls`                                                                                | `/home/{{ ansible_user }}/.keystores/aggregator.bls`                                                                          | `/home/{{ ansible_user }}/.keystores/operator.bls`            |
| bls_private_key_store_password            | Password of the BLS keystore                                                                                                                                                       | <your_bls_keystore_password>                                                                                                        | <your_bls_keystore_password>                                                                                                  | <your_bls_keystore_password>                                  |
| enable_metrics                            | Expose or not prometheus metrics                                                                                                                                                   | `true`                                                                                                                              | `true`                                                                                                                        | `true`                                                        |
| metrics_ip_port_address                   | Where to expose prometheus metrics if enabled                                                                                                                                      | `localhost:9092`                                                                                                                    | `localhost:9092`                                                                                                              | `localhost:9092`                                              |
